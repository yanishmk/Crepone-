...
const MENU: MenuItem[] = [
  ...
  { id: 2,  category: "Crêpes Classiques",     name: "Crêpe classique Nutella & Fraise", price: "$13.99", badge: "🍓 Duo",       rating: "86%",  reviews: 18, description: "Fraises fraîches et Nutella fondant sur crêpe moelleuse et dorée.", photo: "/images/crepe_fraise.jpg" },
  { id: 3,  category: "Crêpes Classiques",     name: "Crêpe classique Banane",           price: "$12.99", badge: "🍌 Fruité",    rating: "84%",  reviews: 12, description: "Rondelles de banane fraîche, Nutella et caramel.", photo: "/images/crepe_banane.jpg" },
  { id: 4,  category: "Crêpes Classiques",     name: "Crêpe classique Oreo",             price: "$19.99", badge: "🖤 Crunch",    rating: "84%",  reviews: 19, description: "Miettes d'Oreo, crème vanille et chocolat fondu.", photo: "/images/crepe_oreo.jpg" },
  { id: 5,  category: "Crêpes Classiques",     name: "Crêpe classique Lotus",            price: "$19.99", badge: "🌟 Fan fav",   rating: "90%",  reviews: 10, isFeatured: true, description: "Pâte Lotus Biscoff et miettes de biscuit caramel.", photo: "/images/crepe_lotus.jpg" },
  { id: 6,  category: "Crêpes Classiques",     name: "Crêpe classique Bueno",            price: "$15.99", badge: "💎 Signature", rating: "75%",  reviews: 12, description: "Kinder Bueno, chocolat au lait et chantilly.", photo: "/images/crepe_bueno.jpg" },
  { id: 7,  category: "Crêpes Classiques",     name: "Crêpe classique Pistache",         price: "$15.99", badge: "💚 Nouveau",   rating: "100%", reviews: 8,  isNew: true, description: "Crème pistache riche et pistaches concassées.", photo: "/images/crepe_pistache.jpg" },
  { id: 8,  category: "Crêpes Classiques",     name: "Crêpe classique Dubai",            price: "$15.99", badge: "⭐ Populaire", rating: "100%", reviews: 9,  isFeatured: true, description: "Crème pistache, kadaifi croustillant et chocolat belge.", photo: "/images/crepe_dubai.jpg" },
  { id: 9,  category: "Crêpes Classiques",     name: "Crêpe fruité",                     price: "$15.99", badge: "🍉 Saison",    rating: "70%",  reviews: 10, description: "Kiwi, fraise, banane et myrtille sur crêpe dorée.", photo: "/images/crepe_fruite.jpg" },
  { id: 10, category: "Crêpes Classiques",     name: "Crêpe Mordjene",                   price: "$13.99", badge: "🌾 Maison",    rating: "88%",  reviews: 14, description: "Crêpe garnie de crème El Mordjene et noisettes grillées.", photo: "/images/crepe_mordjene.jpg" },
  { id: 11, category: "Crêpes Classiques",     name: "Crêpe Halawa",                     price: "$14.99", badge: "✨ Exotique",  rating: "87%",  reviews: 8,  description: "Crêpe à la crème Halawa, pistaches et filet de crème blanche.", photo: "/images/crepe_halawa.jpg" },
  { id: 12, category: "Crêpes Classiques",     name: "Crêpe Gourmande",                  price: "$15.99", badge: "👑 Chef",      rating: "92%",  reviews: 15, description: "M&Ms, Ferrero Rocher et chocolat fondu généreusement.", photo: "/images/crepe_gourmande.jpg" },

  // ── Crêpes Croustillantes ────────────────────────────────────────────────────
  { id: 13, category: "Crêpes Croustillantes", name: "Crêpe croustillante Dubai",        price: "$15.99", badge: "⭐ #1 Vendu",  rating: "100%", reviews: 9,  isFeatured: true, description: "Crêpe croustillante garnie de crème pistache, kadaifi et chocolat belge façon Dubai.", photo: "/images/crepe_dubai.jpg" },
  { id: 14, category: "Crêpes Croustillantes", name: "Crêpe croustillante Pistache",     price: "$15.99", badge: "💚 Pistache",  rating: "88%",  reviews: 6,  description: "Crêpe croustillante garnie de crème pistache et pistaches concassées.", photo: "/images/crepe_pistache.jpg" },
  { id: 15, category: "Crêpes Croustillantes", name: "Crêpe croustillante Gourmandes",   price: "$19.99", badge: "👑 Premium",   rating: "66%",  reviews: 3,  description: "Crêpe croustillante généreusement garnie de toppings gourmands.", photo: "/images/crepe_gourmande.jpg" },

  // ── Gaufres ─────────────────────────────────────────────────────────────────
  { id: 16, category: "Gaufres",               name: "Gaufre Nutella",                   price: "$12.99", badge: "💛 Classique", rating: "86%",  reviews: 20, description: "Gaufre croustillante garnie de Nutella fondant.", photo: "/images/waffle_nutella.jpg" },
  { id: 17, category: "Gaufres",               name: "Gaufre Banane",                    price: "$13.99", badge: "🍌 Fruité",    rating: "84%",  reviews: 10, description: "Gaufre chaude aux bananes fraîches et Nutella.", photo: "/images/waffle_nutella.jpg" },
  { id: 18, category: "Gaufres",               name: "Gaufre Fraise 🍓",                 price: "$17.99", badge: "🍓 Frais",     rating: "88%",  reviews: 15, description: "Gaufre fine et moelleuse aux fraises fraîches et banane.", photo: "/images/waffle_fraise.jpg" },
  { id: 19, category: "Gaufres",               name: "Gaufre Lotus",                     price: "$15.99", badge: "🌟 Fan fav",   rating: "90%",  reviews: 18, description: "Gaufre à la crème Lotus Biscoff, notes caramel et épices.", photo: "/images/waffle_lotus.jpg" },
  { id: 20, category: "Gaufres",               name: "Gaufre Oreo",                      price: "$19.99", badge: "🖤 Crunch",    rating: "84%",  reviews: 19, isFeatured: true, description: "Gaufre moelleuse avec texture croquante de cookies Oreo.", photo: "/images/waffle_oreo.jpg" },
  { id: 21, category: "Gaufres",               name: "Gaufre Bueno",                     price: "$19.99", badge: "💎 Signature", rating: "71%",  reviews: 7,  isFeatured: true, description: "Gaufre à la crème de noisette Kinder Bueno.", photo: "/images/waffle_bueno.jpg" },
  { id: 22, category: "Gaufres",               name: "Gaufre Pistache",                  price: "$14.99", badge: "💚 Exotique",  rating: "90%",  reviews: 8,  description: "Gaufre à la crème de pistache et éclats de pistaches fraîches.", photo: "/images/waffle_pistache.jpg" },
  { id: 23, category: "Gaufres",               name: "Gaufre Gourmande",                 price: "$15.99", badge: "👑 Chef",      rating: "91%",  reviews: 11, description: "Gaufre généreuse : KitKat, M&Ms, Ferrero et chocolat fondu.", photo: "/images/waffle_gourmande.jpg" },
  { id: 24, category: "Gaufres",               name: "Gaufre Dubai",                     price: "$15.99", badge: "⭐ Premium",   rating: "89%",  reviews: 12, isFeatured: true, description: "Gaufre délicate à la crème pistache façon Dubai.", photo: "/images/waffle_dubai.jpg" },

  // ── Croffles ─────────────────────────────────────────────────────────────────
  { id: 25, category: "Croffles",              name: "Croffle lotus biscoff",             price: "$9.99",  badge: "🌟 Fan fav",   rating: "92%",  reviews: 13, isFeatured: true, description: "Croffle garni de chantilly, crème Lotus Biscoff et miettes de biscuit.", photo: "/images/croffle_lotus.jpg" },
  { id: 26, category: "Croffles",              name: "Croffle fraise 🍓",                 price: "$9.99",  badge: "🍓 Frais",     rating: "66%",  reviews: 3,  description: "Croffle aux fraises fraîches, chantilly, coulis de chocolat et sucre glace.", photo: "/images/croffle_strawberry.jpg" },
  { id: 27, category: "Croffles",              name: "Croffle Oreo",                      price: "$9.99",  badge: "🖤 Crunch",    rating: "87%",  reviews: 8,  description: "Croissant façon gaufre garni de crème, miettes d'Oreo et coulis de chocolat.", photo: "/images/croffle_oreo.jpg" },

  // ── Poff's ──────────────────────────────────────────────────────────────────
  { id: 28, category: "Poff's",                name: "Poff's Nutella",                   price: "$12.99", badge: "💛 Classique", rating: "88%",  reviews: 10, description: "Poff's qui combine la douceur avec l'intensité du Nutella.", photo: "/images/poffs_nutella.jpg" },
  { id: 29, category: "Poff's",                name: "Poff's fraise 🍓",                 price: "$19.99", badge: "🍓 Nouveau",   rating: "100%", reviews: 3,  isNew: true, description: "Poff's gourmand aux fraises fraîches.", photo: "/images/poffs_strawberry.jpg" },
  { id: 30, category: "Poff's",                name: "Poff's Oreo",                      price: "$13.99", badge: "🖤 Crunch",    rating: "75%",  reviews: 4,  description: "Texture moelleuse qui contraste avec les cookies croquants.", photo: "/images/poffs_nutella.jpg" },
  { id: 31, category: "Poff's",                name: "Poff's Lotus",                     price: "$13.99", badge: "🌟 Fan fav",   rating: "90%",  reviews: 12, description: "Poff's garni de crème spéculoos aux notes caramel et épices.", photo: "/images/poffs_bueno.jpg" },
  { id: 32, category: "Poff's",                name: "Poff's Pistache",                  price: "$13.99", badge: "💚 Exotique",  rating: "92%",  reviews: 6,  description: "Délicate variation à la crème de pistache.", photo: "/images/poffs_pistachio.jpg" },
  { id: 33, category: "Poff's",                name: "Poff's Bueno",                     price: "$14.99", badge: "💎 Signature", rating: "75%",  reviews: 4,  description: "Poff's à la crème de noisette Kinder Bueno.", photo: "/images/poffs_bueno.jpg" },
  { id: 34, category: "Poff's",                name: "Poff's Banane",                    price: "$19.99", badge: "🍌 Nouveau",   rating: "100%", reviews: 3,  isNew: true, description: "Banane fraîche en duo avec la douceur du Nutella.", photo: "/images/poffs_banane.jpg" },
  { id: 35, category: "Poff's",                name: "Poff's Dubai",                     price: "$14.49", badge: "⭐ Populaire", rating: "77%",  reviews: 9,  isFeatured: true, description: "Crème pistache, pistaches concassées, kounafa croustillant et Nutella.", photo: "/images/poffs_dubai.jpg" },
  { id: 36, category: "Poff's",                name: "Poff's fruité",                    price: "$14.99", badge: "🍉 Saison",    rating: "87%",  reviews: 7,  description: "Crêpe épaisse et moelleuse garnie de fruits mélangés : banane, fraise, ananas, myrtille.", photo: "/images/poffs_strawberry.jpg" },

  // ── Milkshakes ──────────────────────────────────────────────────────────────
  { id: 37, category: "Milkshakes",            name: "Shake Fraise",                     price: "$7.99",  badge: "🍓 Frais",     rating: "88%",  reviews: 18, description: "Milkshake fraise, chantilly et coulis brillant.", photo: "/images/shake_fraise.jpg" },
  { id: 38, category: "Milkshakes",            name: "Shake Banane",                     price: "$7.99",  badge: "🍌 Fruité",    rating: "85%",  reviews: 10, description: "Milkshake banane, caramel et crème fouettée.", photo: "/images/shake_bueno.jpg" },
  { id: 39, category: "Milkshakes",            name: "Shake Oreo",                       price: "$7.99",  badge: "🍪 Bestseller",rating: "92%",  reviews: 25, isFeatured: true, description: "Milkshake Oreo crémeux et finition cookies.", photo: "/images/shake_oreo.jpg" },
  { id: 40, category: "Milkshakes",            name: "Shake Lotus",                      price: "$7.99",  badge: "🌟 Fan fav",   rating: "90%",  reviews: 22, description: "Milkshake Lotus Biscoff et chantilly caramel.", photo: "/images/shake_lotus.jpg" },
  { id: 41, category: "Milkshakes",            name: "Shake KitKat",                     price: "$7.99",  badge: "🍫 Choco",     rating: "87%",  reviews: 11, description: "Milkshake KitKat, chocolat et éclats croustillants.", photo: "/images/shake_oreo.jpg" },
  { id: 42, category: "Milkshakes",            name: "Shake Bueno",                      price: "$7.99",  badge: "💎 Signature", rating: "85%",  reviews: 14, description: "Milkshake Kinder Bueno, noisette et chocolat.", photo: "/images/shake_bueno.jpg" },
  { id: 43, category: "Milkshakes",            name: "Shake Dubai",                      price: "$7.99",  badge: "✨ Nouveau",   rating: "88%",  reviews: 11, isNew: true, description: "Milkshake pistache et kadaifi façon Dubai.", photo: "/images/shake_dubai.jpg" },
  { id: 44, category: "Milkshakes",            name: "Shake Ferrero",                    price: "$7.99",  badge: "🌰 Noisette",  rating: "86%",  reviews: 9,  description: "Milkshake Ferrero Rocher et noisettes grillées.", photo: "/images/shake_bueno.jpg" },

  // ── Smoothies ────────────────────────────────────────────────────────────────
  { id: 45, category: "Smoothies",             name: "Smoothie Fraise & Banane",         price: "$7.99",  badge: "🍓 Frais",     rating: "95%",  reviews: 22, isFeatured: true, description: "Smoothie onctueux fraise et banane, riche et rafraîchissant.", photo: "/images/smoothie_fraise_banane.jpg" },
  { id: 46, category: "Smoothies",             name: "Smoothie Mangue & Ananas",         price: "$7.99",  badge: "🍍 Tropical",  rating: "93%",  reviews: 18, description: "Smoothie tropical mangue et ananas, vitaminé et ensoleillé.", photo: "/images/smoothie_mangue_ananas.jpg" },
  { id: 47, category: "Smoothies",             name: "Smoothie Fruits Rouges",           price: "$7.99",  badge: "🫐 Antioxydant",rating: "91%", reviews: 15, description: "Smoothie fraise, myrtille et framboise, riche en antioxydants.", photo: "/images/smoothie_fruits_rouges.jpg" },
  { id: 48, category: "Smoothies",             name: "Smoothie Mangue & Fraise",         price: "$7.99",  badge: "🥭 Signature", rating: "94%",  reviews: 20, description: "Smoothie mangue et fraise, doux, fruité et coloré.", photo: "/images/smoothie_mangue_fraise.jpg" },

  // ── Strawberry ──────────────────────────────────────────────────────────────
  { id: 49, category: "Strawberry",            name: "Strawberry Dubai",                 price: "$11.99", badge: "⭐ Star",      rating: "86%",  reviews: 45, isFeatured: true, description: "Fraises fraîches, crème pistache Dubai et kadaifi croustillant.", photo: "/images/strawberry-dubai-cup.png" },
  { id: 50, category: "Strawberry",            name: "Strawberry Bueno",                 price: "$10.99", badge: "💎 Signature", rating: "100%", reviews: 8,  description: "Fraises fraîches à la crème Kinder Bueno fondante.", photo: "/images/shake_bueno.jpg" },
];
